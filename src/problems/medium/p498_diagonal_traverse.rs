...
mod tests {
    ...
    fn test_basic_cases() {
        ...
        assert_eq!(find_diagonal_order(mat1), expected1);

        // 示例 2: 2x2 矩陣
        let mat2 = vec![vec![1, 2], vec![3, 4]];
        let expected2 = vec![1, 2, 3, 4];
        assert_eq!(find_diagonal_order(mat2), expected2);
    }
    ...
    fn test_edge_cases() {
        ...
        assert_eq!(find_diagonal_order(mat3), expected3);
    }
    ...
    fn test_corner_cases() {
        ...
        assert_eq!(find_diagonal_order(mat4), expected4);
    }
}
